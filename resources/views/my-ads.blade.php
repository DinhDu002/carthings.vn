                        ...
                        <div class="widget-body">
                            <table class="table table-design">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action">
                                            <a class="label bg-success text-white" title="" data-placement="top"
                                               data-toggle="tooltip" href="#" data-original-title="Edit Ad"><i
                                                        class="fa fa-pencil"></i></a>
                                            <a class="label bg-warning text-white" title="" data-placement="top"
                                               data-toggle="tooltip" href="#" data-original-title="Disable"><i
                                                        class="fa fa-close"></i></a>
                                            <a class="label bg-info text-white" title="" data-placement="top"
                                               data-toggle="tooltip" href="#" data-original-title="View Ad"><i
                                                        class="fa fa-eye"></i></a>
                                            <a class="label bg-danger text-white" title="" data-placement="top"
                                               data-toggle="tooltip" href="#" data-original-title="Delete"><i
