                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="" value="" placeholder="Enter Name" class="form-control"
                                               maxlength="100">
                                    </div>
                                    <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="widget margin-bottom-none">
                        ...
                        <ul class="list list-icons list-icons-style-3 mt-xlg">
                            <li><i class="fa fa-fw fa-map-marker"></i> <strong>Address:</strong> 1234 Street Name, City Name,
                                United States</li>
