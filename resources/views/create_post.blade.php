                        ...
                        <div class="login-body">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="e.g. Apple iPhone SE 2020" required="required" value=""
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="e.g. 999" required="required" value=""
                                               class="form-control border-form">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea placeholder="Include the brand, model, age and any included accessories."
                                              class="form-control border-form"></textarea>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Your Name <span class="required">*</span></label>
                                    <input type="text" placeholder="e.g. Jhone Doe" required="required" value=""
                                           class="form-control border-form">
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Your email <span class="required">*</span></label>
                                    <input type="text" placeholder="e.g. jon@gmail.com" required="required" value=""
                                           class="form-control border-form">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="e.g. 123456789" required="required" value=""
                                               class="form-control border-form">
                                    </div>
                                </div>
                                <div class="form-group text-right margin-bottom-none">
                                    <button type="submit" class="btn btn-success btn-sm"><i class="fa fa-save"></i> Create
                                        ad</button>
