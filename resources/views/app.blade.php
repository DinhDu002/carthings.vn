    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#" aria-expanded="false"> Categories Pages
                        <b
                                class="caret"></b></a>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="{{ route('blog_details') }}"><i class="fa fa-fw fa-angle-right"></i> Blog
                                Details</a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="{{ route('create_post') }}"><i class="fa fa-fw fa-angle-right"></i> Post Your
                                Ad</a>
                        </li>
                        <li>
                    ...
                    <ul class="nav navbar-right top-nav">
                        <li class="dropdown">
                            <a aria-expanded="false" href="#" class="dropdown-toggle" data-toggle="dropdown"><img
                                        src="{{ asset('images/user.jpg') }}" alt="User Image" class="user-dp"> Jhone Doe
                                <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li>
                                ...
                                <li>
                                    <a href="{{ route('favourite') }}"><i class="fa fa-fw fa-heart"></i> Favourite
                                        Ads</a>
                                </li>
                                <li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="site-info text-center">
                        <p>&copy; Copyright 2020 OBootstrap Classified . All Rights Reserved<br> Made with <i
                            ...
                            <a target="_blank" href="https://www.facebook.com/iamgurdeeposahan"><strong>Osahan
                                    Studio</strong></a>
                        </p>
                    </div>
                </div>
    ...
    <div class="popup-box chat-popup">
        ...
        <div id="popup" class="collapse">
            <div class="popup-messages">
                <div class="direct-chat-messages">
                    ...
                    <div class="direct-chat-msg doted-border">
                        ...
                        <!-- /.direct-chat-info -->
                        <img alt="" src="{{ asset('images/user.jpg') }}" class="direct-chat-img">
                        <!-- /.direct-chat-img -->
                        <div class="direct-chat-text">
                            Hey bro, how’s everything going ?
                        </div>
            ...
            <div class="popup-messages-footer">
                <label for="status_message"><textarea id="status_message" placeholder="Type a message..." rows="10"
                                                      cols="40" name="message"></textarea></label>
